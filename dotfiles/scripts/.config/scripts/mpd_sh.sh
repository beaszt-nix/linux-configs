...
choice=$(echo -e $string |rofi -dmenu -font "$font" -p "MPD TOOLS" -fullscreen -columns 3 -lines 10 -padding 20 -color-window "#330b0d13, #330b0d13, #000b0d13" -color-normal "#440b0d13, #e6e6e6, #440b0d13, #880b0d13, #e6e6e6")
...
do
	case $choice in
		...
		' Previous on Playlist')
			...
			;;
		' Add songs to playlist') 
			alacritty -e 'ncmpcpp -s media_library' &
			wal -q -R
			break
			;;
		' Visualizer')
