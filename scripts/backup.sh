...
cp -r $CONFIG/personal_systemd_units $BACKUP
cp -r $CONFIG/qutebrowser $BACKUP
...
cp -r $HOME/.zshrc $BACKUP
cp -r $HOME/.Xdefaults $BACKUP
cp -r $HOME/backup.sh $BACKUP
cp -r $HOME/backup_support.sh $BACKUP
